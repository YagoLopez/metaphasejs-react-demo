...
export const user1 = new User({name: "user1", age: 11, admin: 0});
export const user2 = new User({name: "user2", age: 22, admin: 1});
export const user3 = new User({name: "user3", age: 33, admin: 1});
users.save(user1);
users.save(user2);
users.save(user3);
