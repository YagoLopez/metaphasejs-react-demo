            ...
            React.createElement("div", { className: "ui-grid ui-grid-responsive ui-fluid" },
                ...
                React.createElement("div", { className: "ui-grid-row" },
                    ...
                    React.createElement("div", { className: "dialog-label" },
                        React.createElement(Dropdown, { value: selectedModel ? selectedModel.user_id : '', id: "user_id", options: this.userIds, onChange: function (e) { return _this.onUserIdChange(e.value); }, className: "dropdown marginBottom", placeholder: "User Id" }))))));
    };
    return DialogPost;
}(DialogBase));
export { DialogPost };
