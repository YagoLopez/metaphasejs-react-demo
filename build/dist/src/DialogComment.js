...
var DialogComment = /** @class */ (function (_super) {
    ...
    DialogComment.prototype.render = function () {
        ...
        return (React.createElement(Dialog, { visible: displayDialog, header: "Edit Row", modal: true, footer: footerDialog, onHide: function () { return _this.setState({ displayDialog: false }); } },
            React.createElement("div", { className: "ui-grid ui-grid-responsive ui-fluid" },
                ...
                React.createElement("div", { className: "ui-grid-row" },
                    ...
                    React.createElement("div", { className: "ui-grid-col-8 dialog-label" },
                        React.createElement(InputText, { id: "date", onChange: function (e) { _this.updateProperty('date', e.target.value); }, value: selectedModel ? selectedModel.date : '' }))),
                React.createElement("div", { className: "ui-grid-row" },
                    React.createElement("div", { className: "ui-grid-col-4 dialog-label" },
                        React.createElement("label", { htmlFor: "post_id" }, "User Id")),
                    React.createElement("div", { className: "dialog-label" },
                        React.createElement(Dropdown, { value: selectedModel ? selectedModel.post_id : '', id: "post_id", options: this.userIds, onChange: function (e) { return _this.onPostIdChange(e.value); }, className: "dropdown marginBottom", placeholder: "User Id" }))))));
    };
