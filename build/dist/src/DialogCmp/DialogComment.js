            ...
            React.createElement("div", { className: "ui-grid ui-grid-responsive ui-fluid" },
                ...
                React.createElement("div", { className: "ui-grid-row" },
                    ...
                    React.createElement("div", { className: "dialog-label" },
                        React.createElement(Dropdown, { value: selectedModel ? selectedModel.post_id : '', id: "post_id", options: this.postIds, onChange: function (e) { return _this.onPostIdChange(e.value); }, className: "dropdown marginBottom", placeholder: "Post Id" }))))));
    };
