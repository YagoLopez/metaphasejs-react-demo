...
var DialogComment = /** @class */ (function (_super) {
    ...
    DialogComment.prototype.render = function () {
        ...
        return (React.createElement(Dialog, { visible: displayDialog, header: "Comment", modal: true, responsive: false, footer: footerDialog, onHide: function () { return _this.setState({ displayDialog: false }); } },
