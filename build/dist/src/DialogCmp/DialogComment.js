...
var DialogComment = /** @class */ (function (_super) {
    ...
    DialogComment.prototype.render = function () {
        ...
        return (React.createElement(Dialog, { visible: displayDialog, header: "Edit Comment", modal: true, responsive: false, footer: footerDialog, onHide: function () { return _this.setState({ displayDialog: false }); } },
                ...
                React.createElement("div", { className: "ui-grid-row" },
                    React.createElement("div", { className: "ui-grid-col-4 dialog-label" },
                        React.createElement("label", { htmlFor: "date" },
                            "Date ",
                            React.createElement("span", { className: "dialog-small" }, "(mm/dd/yy)"))),
                    React.createElement("div", { className: "ui-grid-col-8 dialog-label" },
