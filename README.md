...
- State can be managed with SQL queries generated by Metaphase ORM (Object Relational Mapper). It follows the patterns:
...
- You can load the state from a database file or from a dababase created with code
...
```typescript
// --------------------------------------------------------------------
// This example is coded in Typescript using decorators
...
<p align="center"><a href="#">Back to top </a></p> :arrow_up: