...
- Store in Redux is essentially a big key-value object which is not appropiated for nested and relational data
...
- State can be managed with SQL queries generated by an ORM (Object Relational Mapper). It follows the patterns:
