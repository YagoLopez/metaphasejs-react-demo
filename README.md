...
- State can be managed with SQL queries generated by Metaphase ORM ([Object-Relational Mapper](https://en.wikipedia.org/wiki/Object-relational_mapping)). It offers the following patterns:
  - [Data-Mapper](https://en.wikipedia.org/wiki/Data_mapper_pattern)/[Repository](https://martinfowler.com/eaaCatalog/repository.html)
...
- You can load the state from a database file or from a database created with code
